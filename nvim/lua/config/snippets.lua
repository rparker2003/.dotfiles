...
local snippets = {
  ...
  cpp = {
    ...
    "",
    "// Compile / Run:",
    "// g++ -I ~/ampsClients/amps-c++-client-5.3.5.1-Linux/include/ Example.cpp ~/ampsClients/amps-c++-client-5.3.5.1-Linux/lib/x86_64/debug/libamps.a -o Example",
  ...
  java = {
    ...
    "        }",
    "        catch (AMPSException | IOException e) {",
