...
# Modified Script for Zendesk Search
...
rofi_config="$HOME/.config/rofi/config-zendesk-search.rasi"
...
echo "" | rofi -dmenu -config "$rofi_config" | xargs -I{} xdg-open "https://crankuptheamps.zendesk.com/agent/tickets/{}"
