...
# Modified Script for Jira Search
...
rofi_config="$HOME/.config/rofi/config-jira-search.rasi"
...
echo "" | rofi -dmenu -config "$rofi_config" | xargs -I{} xdg-open "https://crankuptheamps.atlassian.net/browse/{}"
